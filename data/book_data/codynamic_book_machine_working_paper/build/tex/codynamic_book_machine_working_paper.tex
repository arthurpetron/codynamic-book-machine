...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch01_sec01_problem__media_req_5880ed833050.tikz}
\caption{Conceptual diagram for 'The Coordination Problem in Long-Form Writing': Explain why books are difficult to manage when outlines, drafts, citations, diagrams, reviews, and builds drift apart.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch02_sec02_sub01_depth__media_req_3c6806d58eb0.tikz}
\caption{Conceptual diagram for 'Depth Without Special Cases': Show how the same structural element supports chapter, section, and subsection nodes.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch03_sec01_conversation__media_req_b1efeab6b5ed.tikz}
\caption{Conceptual diagram for 'Conversational Intake': Explain the question bank: title, purpose, audience, reader takeaway, voice, genre, design spec, and artifact structure.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch03_sec03_repository__media_req_22731fb7c078.tikz}
...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch04_sec01_agent_roles__media_req_4630b3fd76e1.tikz}
\caption{Conceptual diagram for 'Agent Roles': Map the major agents to their responsibilities: hypervision, outlining, section drafting, gardening, diagrams, design, references, and assembly.}
\end{figure}
...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch04_sec03_messages__media_req_e612c9613878.tikz}
\caption{Conceptual diagram for 'Messaging and Runtime Memory': Explain routed messages, subscriptions, durable logs, task prompts, agent runtime registry, and coordination records.}
\end{figure}
