...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch08_sec03_future_work__media_req_5f514d8de5bd.tikz}
\caption{Conceptual diagram for 'Future Work': Identify improvements such as richer diagram planning, better global revision scheduling, stronger reference retrieval, UI observability, and more formal evaluation.}
\end{figure}
