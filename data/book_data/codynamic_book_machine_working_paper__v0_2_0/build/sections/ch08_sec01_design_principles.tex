...
\begin{figure}[htbp]
\centering
\input{media/diagrams/ch08_sec01_design_principles__media_req_539dbeb3e2f2.tikz}
\caption{Conceptual diagram for ``Design Principles'': Summarize the architecture's principles: durable state, explicit queues, specialist ownership, reversible edits, visible messages, and schema-first authoring.}
\end{figure}
